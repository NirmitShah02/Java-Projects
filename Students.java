...
public class Students {
    public static void main(String[] args) {
        Student s1 = new Student(10001, "ABC", 8.50);
        Student s2 = new Student(10002, 8.77);
        Undergrad u1 = new Undergrad(112244, "XYZ", 9.10, "Fresher");
        Graduate g1 = new Graduate(425030, "PQR", 7.78, "Programing on Java");
